...
evoplot(model=evomodel, name="ageSPVL_m06")

popatts1 <- ageSPVL_m01$pop[[1]]
plot(popatts1$age_infection[popatts1$Time_Inf>0],
     log(popatts1$SetPoint[popatts1$Time_Inf>0],10))
popatts6 <- ageSPVL_m06$pop[[1]]
plot(popatts6$age_infection[popatts6$Time_Inf>0],
     log(popatts6$SetPoint[popatts6$Time_Inf>0],10))
...
summary(glm(log(popatts6$SetPoint[popatts6$Time_Inf>0],10)~
              popatts6$age_infection[popatts6$Time_Inf>0]+
              popatts6$Time_Inf[popatts6$Time_Inf>0]))
summary(glm(log(popatts1$SetPoint[popatts1$Time_Inf>0],10)~
              popatts1$age_infection[popatts1$Time_Inf>0]))
summary(glm(log(popatts6$SetPoint[popatts6$Time_Inf>0],10)~
              popatts6$age_infection[popatts6$Time_Inf>0]))
...
mean(popatts6$age_infection[popatts6$Time_Inf>0], na.rm=T)
